...
import gramophon from '../public/images/gramophone-1000px.png';
import { BtnFullProducts } from './_components/Buttons';
  ...
  return (
    <div className={styles.hero}>
      <div className={styles.heroLeft}>
        <h1>sounds like the good old days</h1>
        <Link href="/products">
          <BtnFullProducts />
        </Link>
      </div>
      <div className={styles.heroRight}>
        <Image alt="gramophon" src={gramophon} />
      </div>
